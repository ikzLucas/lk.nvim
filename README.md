...
A personal Neovim distribution based on kickstart.nvim, with modern IDE-like features
...
- A [Nerd Font](https://www.nerdfonts.com/): **Required** by default, provides various icons
  - unless `vim.g.have_nerd_font` in `init.lua` is set to false
...
```sh
git clone https://github.com/ikzLucas/lk.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
